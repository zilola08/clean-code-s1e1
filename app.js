...
var taskInput=document.querySelector(".task-add-input");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='list__item incomplete-tasks__item';
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector(".input.task-text");
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.className='list__item completed-tasks__item';
